function robotRefState = exMobileRobotController(purePursuitObj, robotPose, robotGoal, goalRadius)
...
distanceToGoal = norm(robotPose(1:2) - robotGoal(1:2));
if distanceToGoal < goalRadius %&& robotGoal(3)-robotPose(3)<0.05
    vRef = 0;
    wRef = 0;
end
